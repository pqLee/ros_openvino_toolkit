...
void Outputs::ImageWindowOutput::accept(const std::vector<vino_core_lib::LicensePlateDetectionResult>& results)
{
...
void Outputs::ImageWindowOutput::accept(const std::vector<vino_core_lib::VehicleAttribsDetectionResult>& results)
{
  for (unsigned i = 0; i < results.size(); i++)
  {
    cv::Rect result_rect = results[i].getLocation();
...
void Outputs::ImageWindowOutput::accept(const std::vector<vino_core_lib::FaceDetectionResult>& results)
{
  for (unsigned i = 0; i < results.size(); i++)
  {
    cv::Rect result_rect = results[i].getLocation();
...
void Outputs::ImageWindowOutput::accept(const std::vector<vino_core_lib::EmotionsResult>& results)
{
  for (unsigned i = 0; i < results.size(); i++)
  {
    cv::Rect result_rect = results[i].getLocation();
...
void Outputs::ImageWindowOutput::accept(const std::vector<vino_core_lib::AgeGenderResult>& results)
{
  for (unsigned i = 0; i < results.size(); i++)
  {
    cv::Rect result_rect = results[i].getLocation();
...
void Outputs::ImageWindowOutput::accept(const std::vector<vino_core_lib::HeadPoseResult>& results)
{
  for (unsigned i = 0; i < results.size(); i++)
  {
...
void Outputs::ImageWindowOutput::accept(const std::vector<vino_core_lib::ObjectDetectionResult>& results)
{
  for (unsigned i = 0; i < results.size(); i++)
  {
    cv::Rect result_rect = results[i].getLocation();
...
void Outputs::ImageWindowOutput::mergeMask(const std::vector<vino_core_lib::ObjectSegmentationResult>& results)
{
...
void Outputs::ImageWindowOutput::accept(const std::vector<vino_core_lib::ObjectSegmentationResult>& results)
{
  if (outputs_.size() == 0)
  {
...
void Outputs::ImageWindowOutput::accept(const std::vector<vino_core_lib::PersonAttribsDetectionResult>& results)
{
  for (unsigned i = 0; i < results.size(); i++)
  {
    cv::Rect result_rect = results[i].getLocation();
...
void Outputs::ImageWindowOutput::accept(const std::vector<vino_core_lib::PersonReidentificationResult>& results)
{
  for (unsigned i = 0; i < results.size(); i++)
  {
    cv::Rect result_rect = results[i].getLocation();
...
void Outputs::ImageWindowOutput::accept(const std::vector<vino_core_lib::FaceReidentificationResult>& results)
{
  for (unsigned i = 0; i < results.size(); i++)
  {
    cv::Rect result_rect = results[i].getLocation();
...
void Outputs::ImageWindowOutput::accept(const std::vector<vino_core_lib::LandmarksDetectionResult>& results)
{
  for (unsigned i = 0; i < results.size(); i++)
  {
    cv::Rect result_rect = results[i].getLocation();
